...
import { Eye, EyeOff, Mail, Lock, User, Chrome, UserCheck, CheckCircle, Heart } from "lucide-react"
      ...
      >
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 text-center pb-8">
            ...
            <CardDescription className="text-gray-600">Join the health awareness community today</CardDescription>
          </CardHeader>
